...
from triggerWrite import serialPort
import vizshape
import vizact
import viz
import viztask
...
myserial = serialPort(portx='COM3')
...
def stistage():
	for i in range(len(position)):
		if i<=11 and i!=10:
			...
			squares['square'+str(i)].addAction(stiInitialalpha(stimulationLength,frequence[10],phase[10],framerate))
	yield None
